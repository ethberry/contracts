...
contract ERC998ERC1155TopDown is ERC721ACBCES, ERC1155Receiver, IERC998ERC1155TopDown {
   ...
   */
  function childContractsFor(uint256 tokenId) external view override returns (address[] memory) {
   ...
   */
  function childIdsForOn(uint256 tokenId, address childContract) external view override returns (uint256[] memory) {
