...
import "../../ERC721/preset/ERC721ACBERS.sol";
import "../ERC998ERC721.sol";

contract ERC998ERC721ACBERS is ERC721ACBERS, ERC998ERC721 {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty
  ) ERC721ACBERS(name, symbol, royalty) {}
  ...
  function _beforeTokenTransfer(
    ...
    address to,
    uint256 tokenId
  ) internal virtual override(ERC721ACBERS, ERC998ERC721) {
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(ERC721ACBERS, ERC998ERC721)
    returns (bool)
  {
