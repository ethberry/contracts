...
contract ERC998ERC721ERC20ACBERS is ERC998ERC721ACBERS, ERC998ERC20 {
  constructor(
    string memory name,
  ...
  function ownerOf(uint256 tokenId) public view virtual override(ERC998ERC721ACBERS, ERC998ERC20) returns (address) {
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(ERC998ERC721ACBERS, ERC998ERC20)
    returns (bool)
  {
