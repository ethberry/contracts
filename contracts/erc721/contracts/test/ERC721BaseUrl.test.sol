...
contract ERC721BaseUrlTest is ERC721ABRS, ERC721ABaseUrl {
  constructor(string memory name, string memory symbol, uint96 royaltyNumerator, string memory baseTokenURI)
    ERC721ABRS(name, symbol, royaltyNumerator)
    ERC721ABaseUrl(baseTokenURI)
  {}
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(AccessControl, ERC721ABRS)
    returns (bool)
  {
