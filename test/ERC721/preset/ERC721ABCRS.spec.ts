...
import { ERC721ABCRS, ERC721NonReceiverMock, ERC721ReceiverMock } from "../../../typechain-types";
...
describe("ERC721ABCRS", function () {
  ...
  beforeEach(async function () {
    erc721 = await ethers.getContractFactory("ERC721ABCRS");
    ...
    this.erc721Instance = (await erc721.deploy(tokenName, tokenSymbol, 2, royalty)) as ERC721ABCRS;
