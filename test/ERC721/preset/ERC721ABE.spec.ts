...
import { ERC721ABE, ERC721NonReceiverMock, ERC721ReceiverMock } from "../../../typechain-types";
...
describe("ERC721ABE", function () {
  ...
  beforeEach(async function () {
    erc721 = await ethers.getContractFactory("ERC721ABE");
    ...
    this.erc721Instance = (await erc721.deploy(tokenName, tokenSymbol)) as ERC721ABE;
