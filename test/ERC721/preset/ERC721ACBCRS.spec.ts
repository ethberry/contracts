...
import { ERC721ACBCRS, ERC721NonReceiverMock, ERC721ReceiverMock } from "../../../typechain-types";
...
describe("ERC721ACBCRS", function () {
  let erc721: ContractFactory;
  let erc721Receiver: ContractFactory;
  let erc721NonReceiver: ContractFactory;

  beforeEach(async function () {
    erc721 = await ethers.getContractFactory("ERC721ACBCRS");
    ...
    this.erc721Instance = (await erc721.deploy(tokenName, tokenSymbol, baseTokenURI, 2, royalty)) as ERC721ACBCRS;
