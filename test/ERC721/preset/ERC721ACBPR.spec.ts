...
import { ERC721ACBPR, ERC721NonReceiverMock, ERC721ReceiverMock } from "../../../typechain-types";
import {
  baseTokenURI,
  DEFAULT_ADMIN_ROLE,
  MINTER_ROLE,
...
describe("ERC721ACBPR", function () {
  ...
  beforeEach(async function () {
    ...
    this.erc721Instance = (await erc721.deploy(tokenName, tokenSymbol, baseTokenURI, royaltyNumerator)) as ERC721ACBPR;
