...
import { baseTokenURI, royaltyNumerator, tokenName, tokenSymbol } from "../../constants";
...
describe("ERC721OBR", function () {
  ...
  beforeEach(async function () {
    ...
    this.erc721Instance = (await erc721.deploy(tokenName, tokenSymbol, baseTokenURI, royaltyNumerator)) as ERC721ACBR;
