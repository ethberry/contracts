...
export function shouldPause() {
  describe("pause", function () {
    ...
    it("should pause/unpause", async function () {
      const tx1 = this.erc721Instance.mint(this.owner.address);
      ...
      const tx3 = this.erc721Instance.mint(this.owner.address);
      ...
      const tx5 = this.erc721Instance.mint(this.owner.address);
