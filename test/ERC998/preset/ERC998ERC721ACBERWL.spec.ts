...
import { ERC721ACBCE, ERC721NonReceiverMock, ERC721ReceiverMock, ERC998ERC721ACBERSWL } from "../../../typechain-types";
...
describe("ERC998ERC721ACBERSWL", function () {
  ...
  beforeEach(async function () {
    ...
    erc998 = await ethers.getContractFactory("ERC998ERC721ACBERSWL");
    ...
    this.erc721Instance = (await erc998.deploy(tokenName, tokenSymbol, 1000)) as ERC998ERC721ACBERSWL;
