...
interface ERC20PresetFixedSupplyUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20PresetFixedSupplyUpgradeable extends BaseContract {
