...
interface ERC721PresetMinterPauserAutoIdUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721PresetMinterPauserAutoIdUpgradeable extends BaseContract {
