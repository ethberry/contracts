...
interface IERC721VerifiableUpgradeableInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "verifyFingerprint", values: [BigNumberish, BytesLike]): string;
  ...
  decodeFunctionResult(functionFragment: "verifyFingerprint", data: BytesLike): Result;
...
export class IERC721VerifiableUpgradeable extends BaseContract {
  ...
  interface: IERC721VerifiableUpgradeableInterface;
  ...
  functions: {
    ...
    verifyFingerprint(arg0: BigNumberish, arg1: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
  };
  ...
  estimateGas: {
    ...
    verifyFingerprint(arg0: BigNumberish, arg1: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    verifyFingerprint(arg0: BigNumberish, arg1: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
